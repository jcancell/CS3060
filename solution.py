...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Cube(name="LeftLowerLeg", pos=[0, 0, -.5], size=[0.2, 0.2, 1],mass=1.0)
        ...
        pyrosim.Send_Cube(name="RightLowerLeg", pos=[0, 0, -.5], size=[0.2, 0.2, 1],mass=1.0)
